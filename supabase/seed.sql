...
values
  ('33333333-1111-0001-000000000001', '11111111-1111-1111-1111-000000000001',
   'Vendor sourcing wizard',
   'Step-by-step wizard for finding and inviting vendors to bid, replacing the old one-shot dialog.',
   'live', 1, 1.5, 3.0),

  ('33333333-1111-0001-000000000002', '11111111-1111-1111-1111-000000000001',
  ...
  ('33333333-1111-0001-000000000003', '11111111-1111-1111-1111-000000000001',
  ...
  ('33333333-1111-0001-000000000004', '11111111-1111-1111-1111-000000000001',
   'Scope approval gate',
   'Blocks bid approval until the project scope has been formally signed off. Prevents downstream change-order rework.',
   'in_dev', 4, 4.0, 6.0),

  ('33333333-1111-0001-000000000005', '11111111-1111-1111-1111-000000000001',
   'Improved PDF export',
   'Cleaner bid sheet PDFs with better handling of long vendor names and multi-section layouts.',
   'in_dev', 5, 4.0, 6.5),

  ('33333333-1111-0001-000000000006', '11111111-1111-1111-1111-000000000001',
  ...
  ('33333333-1111-0001-000000000007', '11111111-1111-1111-1111-000000000001',
...
insert into features (id, project_id, name, description, status, sort_order, timeline_start, timeline_end)
values
  ('33333333-1111-0003-000000000001', '11111111-1111-1111-1111-000000000003',
   'Floating feedback widget',
   'A small button anchored to the bottom-right of every portal page that opens a feedback form on click.',
   'in_dev', 1, 4.0, 7.0),

  ('33333333-1111-0003-000000000002', '11111111-1111-1111-1111-000000000003',
  ...
  ('33333333-1111-0003-000000000003', '11111111-1111-1111-1111-000000000003',
...
values
  ('44444444-0001-000000000001', '11111111-1111-1111-1111-000000000001',
  ...
  ('44444444-0001-000000000002', '11111111-1111-1111-1111-000000000001',
  ...
  ('44444444-0001-000000000003', '11111111-1111-1111-1111-000000000001',
  ...
  ('44444444-0001-000000000004', '11111111-1111-1111-1111-000000000001',
  ...
  ('44444444-0001-000000000005', '11111111-1111-1111-1111-000000000001',
...
values
  ('44444444-0002-000000000001', '11111111-1111-1111-1111-000000000002', 'BC-7610', 'Portal login DNS cutover', 'live',   'high',     'evanedgeworth/buildcore-client-portal', null),
  ('44444444-0002-000000000002', '11111111-1111-1111-1111-000000000002', 'BC-7665', 'User mapping import script',  'in_dev', 'critical', 'evanedgeworth/buildcore-client-portal', 'feat/user-mapping'),
  ('44444444-0002-000000000003', '11111111-1111-1111-1111-000000000002', 'BC-7670', 'Legacy order history backfill', 'in_dev', 'high',  'evanedgeworth/buildcore-client-portal', 'feat/order-backfill'),
  ('44444444-0002-000000000004', '11111111-1111-1111-1111-000000000002', 'BC-7700', 'Migration dry-run report',     'created','high',     'evanedgeworth/buildcore-client-portal', null);

-- Tickets — feedback tracker
insert into tickets (id, project_id, ref, title, stage, priority)
values
  ('44444444-0003-000000000001', '11111111-1111-1111-1111-000000000003', 'BC-7750', 'Widget shell + open/close interaction', 'created', 'high');
...
insert into feature_tickets (feature_id, ticket_id) values
  -- Vendor sourcing wizard
  ('33333333-1111-0001-000000000001', '44444444-0001-000000000004'),
  ('33333333-1111-0001-000000000001', '44444444-0001-000000000005'),
  -- Drag-and-drop line items
  ('33333333-1111-0001-000000000002', '44444444-0001-000000000003'),
  -- Role-based approval permissions
  ('33333333-1111-0001-000000000003', '44444444-0001-000000000001'),
  -- Scope approval gate
  ('33333333-1111-0001-000000000004', '44444444-0001-000000000002'),
  -- Improved PDF export
  ('33333333-1111-0001-000000000005', '44444444-0001-000000000008'),
  -- Inline vendor approval editing
  ('33333333-1111-0001-000000000006', '44444444-0001-000000000007'),
  -- Migration: bids table backfill
  ('33333333-1111-0001-000000000007', '44444444-0001-000000000006'),
  -- Portal DNS cutover
  ('33333333-1111-0002-000000000001', '44444444-0002-000000000001'),
  -- User mapping
  ('33333333-1111-0002-000000000002', '44444444-0002-000000000002'),
  -- Order backfill
  ('33333333-1111-0002-000000000003', '44444444-0002-000000000003'),
  -- Dry-run
  ('33333333-1111-0002-000000000004', '44444444-0002-000000000004'),
  -- Feedback tracker widget
  ('33333333-1111-0003-000000000001', '44444444-0003-000000000001');
...
insert into ticket_acceptance (ticket_id, text, checked, sort_order) values
  ('44444444-0001-000000000001', 'Approve button hidden when current user lacks scope_approval authority', true,  1),
  ('44444444-0001-000000000001', 'Approve button visible but disabled when authority present but projects area is view-only', true, 2),
  ('44444444-0001-000000000001', 'Server-side check rejects approval POST when caller lacks authority, returns 403', true, 3),
  ('44444444-0001-000000000001', 'Audit row written to bid_approval_audit on every attempt (approved AND rejected)', false, 4),
  ('44444444-0001-000000000001', 'Unit tests cover all 9 roles against the approve endpoint', false, 5),

  ('44444444-0001-000000000002', 'Bid review page shows a Scope-status banner (pending / approved / rejected)', true, 1),
  ('44444444-0001-000000000002', 'Approve button disabled when scope status is pending or rejected', true, 2),
  ('44444444-0001-000000000002', 'Tooltip explains why button is disabled', false, 3),
  ('44444444-0001-000000000002', 'API endpoint returns 422 with reason when scope not approved', false, 4),

  ('44444444-0001-000000000003', 'Drag handle visible on hover for each line item', true, 1),
  ('44444444-0001-000000000003', 'Drop indicator shows where the item will land', true, 2),
  ('44444444-0001-000000000003', 'Order persists after page refresh', true, 3),
  ('44444444-0001-000000000003', 'Optimistic UI — reorder visible immediately, rollback on save error', true, 4),
  ('44444444-0001-000000000003', 'Keyboard accessible — Up/Down arrows with modifier reorder', true, 5);

-- ---------------------------------------------------------------------------
-- Ticket files-likely-to-touch
-- ---------------------------------------------------------------------------
insert into ticket_files (ticket_id, path, note, sort_order) values
  ('44444444-0001-000000000001', 'src/app/(dashboard)/projects/[id]/bids/[bidId]/page.tsx', 'hide/disable Approve button', 1),
  ('44444444-0001-000000000001', 'src/app/api/bids/[bidId]/approve/route.ts',                'server-side authority check', 2),
  ('44444444-0001-000000000001', 'src/lib/permissions.ts',                                    'add hasAuthority() helper', 3),
  ('44444444-0001-000000000001', 'src/hooks/usePermissions.ts',                               'client hook reads current user authorities', 4),

  ('44444444-0001-000000000002', 'src/app/(dashboard)/projects/[id]/bids/[bidId]/page.tsx', 'add scope status banner', 1),
  ('44444444-0001-000000000002', 'src/components/ScopeStatusBanner.tsx',                     'new component', 2),
  ('44444444-0001-000000000002', 'src/app/api/bids/[bidId]/approve/route.ts',                'add scope check', 3),

  ('44444444-0001-000000000003', 'src/components/BidLineItemList.tsx', 'drag context + handle', 1),
  ('44444444-0001-000000000003', 'src/hooks/useBidLineOrder.ts',       'reorder logic + persistence', 2),
  ('44444444-0001-000000000003', 'src/app/api/bids/[bidId]/lines/reorder/route.ts', 'new endpoint', 3);

-- ---------------------------------------------------------------------------
-- Ticket activity log
-- ---------------------------------------------------------------------------
insert into ticket_activity (ticket_id, who, what, meta, source, occurred_at) values
  ('44444444-0001-000000000001', 'Evan agent', 'opened PR #234',                                 null,                  'github', now() - interval '2 hours'),
  ('44444444-0001-000000000001', 'Evan agent', 'pushed 4 commits to feat/bid-approver-permissions', null,              'github', now() - interval '5 hours'),
  ('44444444-0001-000000000001', 'Evan agent', 'moved',                                          'In dev → On stage',   'agent',  now() - interval '12 minutes'),
  ('44444444-0001-000000000001', 'Tyler',      'created from handoff',                           null,                  'manual', now() - interval '2 days'),

  ('44444444-0001-000000000002', 'Evan agent', 'opened PR #241',                                 null,                  'github', now() - interval '8 hours'),
  ('44444444-0001-000000000002', 'Evan agent', 'moved',                                          'Created → In dev',    'agent',  now() - interval '1 day'),
  ('44444444-0001-000000000002', 'Tyler',      'created from handoff',                           null,                  'manual', now() - interval '2 days'),

  ('44444444-0001-000000000003', 'Evan agent', 'moved',                                          'On stage → Ready',    'agent',  now() - interval '2 days'),
  ('44444444-0001-000000000003', 'Evan agent', 'opened PR #218',                                 null,                  'github', now() - interval '4 days'),
  ('44444444-0001-000000000003', 'Tyler',      'created from handoff',                           null,                  'manual', now() - interval '5 days');
...
insert into test_cases (id, project_id, feature_id, name, steps, expected, status, owner, last_run_at, failure_note, sort_order) values
  -- Vendor sourcing wizard
  ('55555555-0001-000000000001', '11111111-1111-1111-1111-000000000001', '33333333-1111-0001-000000000001', 'Select vendor type from list', array['Open new bid', 'Click Add vendor', 'Choose Plumber'], 'Wizard advances to step 2.', 'passed', 'Tyler', now() - interval '5 days', null, 1),
  ('55555555-0001-000000000002', '11111111-1111-1111-1111-000000000001', '33333333-1111-0001-000000000001', 'Search vendors by name',       array['On step 2', 'Type "Smith"'], 'Results filter to vendors with "Smith" in their name.', 'passed', 'Tyler', now() - interval '5 days', null, 2),
  ('55555555-0001-000000000003', '11111111-1111-1111-1111-000000000001', '33333333-1111-0001-000000000001', 'Send invite to vendor',        array['Pick a vendor', 'Click Send invite'], 'Vendor receives email; status moves to Invited.', 'passed', 'Tyler', now() - interval '5 days', null, 3),

  -- Drag-and-drop line items
  ('55555555-0001-000000000010', '11111111-1111-1111-1111-000000000001', '33333333-1111-0001-000000000002', 'Drag item up within a section',   array['Open a bid with 3+ line items', 'Drag item 3 to position 1'], 'Item reorders; order persists after refresh.', 'passed', 'Tyler', now() - interval '1 day', null, 1),
  ('55555555-0001-000000000011', '11111111-1111-1111-1111-000000000001', '33333333-1111-0001-000000000002', 'Drag item down within a section', array['Open a bid', 'Drag item 1 to position 3'], 'Item reorders; order persists.', 'passed', 'Tyler', now() - interval '1 day', null, 2),
  ('55555555-0001-000000000012', '11111111-1111-1111-1111-000000000001', '33333333-1111-0001-000000000002', 'Drop indicator shows correct position', array['Start dragging an item', 'Hover between items'], 'A horizontal blue line appears where the item will land.', 'passed', 'Tyler', now() - interval '1 day', null, 3),
  ('55555555-0001-000000000013', '11111111-1111-1111-1111-000000000001', '33333333-1111-0001-000000000002', 'Keyboard reorder with Cmd+Up/Down', array['Focus a line item', 'Press Cmd+Up'], 'Item moves up one position.', 'passed', 'Tyler', now() - interval '1 day', null, 4),

  -- Role-based approval permissions
  ('55555555-0001-000000000020', '11111111-1111-1111-1111-000000000001', '33333333-1111-0001-000000000003', 'Project Manager can approve',                     array['Log in as PM', 'Open a bid with scope approved', 'Click Approve'], 'Bid is marked approved.', 'passed', 'Tyler', now() - interval '4 hours', null, 1),
  ('55555555-0001-000000000021', '11111111-1111-1111-1111-000000000001', '33333333-1111-0001-000000000003', 'Field Tech cannot approve',                       array['Log in as Field Tech', 'Open a bid'], 'Approve button is hidden.', 'passed', 'Tyler', now() - interval '4 hours', null, 2),
  ('55555555-0001-000000000022', '11111111-1111-1111-1111-000000000001', '33333333-1111-0001-000000000003', 'Approve button hidden for view-only roles',       array['Log in as Auditor', 'Open a bid'], 'Approve button is hidden.', 'passed', 'Tyler', now() - interval '4 hours', null, 3),
  ('55555555-0001-000000000023', '11111111-1111-1111-1111-000000000001', '33333333-1111-0001-000000000003', 'Server rejects unauthorized approval POST',       array['As Field Tech, send POST to /api/bids/.../approve'], 'API responds 403.', 'in_progress', 'Evan', null, null, 4),
  ('55555555-0001-000000000024', '11111111-1111-1111-1111-000000000001', '33333333-1111-0001-000000000003', 'Audit log row written for every attempt',          array['Attempt an approval (success or fail)', 'Query bid_approval_audit table'], 'A new row exists with user_id, bid_id, attempted_at, and result.', 'failed', 'Evan', now() - interval '1 hour', 'No row was written when the attempt was rejected for missing authority. Audit only fires on success path.', 5),

  -- Scope approval gate
  ('55555555-0001-000000000030', '11111111-1111-1111-1111-000000000001', '33333333-1111-0001-000000000004', 'Approve disabled when scope is pending',  array['Open a bid where scope status is pending', 'Hover Approve'], 'Approve button is disabled.', 'passed', 'Tyler', now() - interval '4 hours', null, 1),
  ('55555555-0001-000000000031', '11111111-1111-1111-1111-000000000001', '33333333-1111-0001-000000000004', 'Approve disabled when scope is rejected', array['Open a bid where scope is rejected'], 'Approve button is disabled.', 'in_progress', 'Tyler', null, null, 2),
  ('55555555-0001-000000000032', '11111111-1111-1111-1111-000000000001', '33333333-1111-0001-000000000004', 'API returns 422 when scope not approved', array['Send approval POST'], 'Response is 422 with reason "scope_not_approved" and bid unchanged.', 'not_started', 'Evan', null, null, 3),

  -- Improved PDF export
  ('55555555-0001-000000000040', '11111111-1111-1111-1111-000000000001', '33333333-1111-0001-000000000005', 'Long vendor names wrap correctly',     array['Generate PDF from bid with vendor name longer than 40 chars', 'Open the PDF'], 'Vendor name wraps onto a second line; no overflow off page.', 'failed', 'Tyler', now() - interval '3 hours', 'Vendor name "Smith Construction and Renovation Services LLC" still overflows the right edge of the page on the cover page. Body sections wrap correctly — looks like the cover-page header style is missing the word-break rule.', 1),
  ('55555555-0001-000000000041', '11111111-1111-1111-1111-000000000001', '33333333-1111-0001-000000000005', 'Multi-section bid renders all sections', array['Bid with 3 sections', 'Generate PDF'], 'All three sections render in order.', 'not_started', 'Tyler', null, null, 2);

-- Test cases — Client portal migration
insert into test_cases (id, project_id, feature_id, name, steps, expected, status, owner, last_run_at, failure_note, sort_order) values
  ('55555555-0002-000000000001', '11111111-1111-1111-1111-000000000002', '33333333-1111-0002-000000000002', 'Legacy user can log in with old email', array['Run migration', 'Log in as a legacy user'], 'Login succeeds and lands on portal home.', 'failed', 'Tyler', now() - interval '6 hours', 'After cutover, ~3% of legacy users hit a 404 page instead of the portal home. Reproduces 100% for users whose email contained a + sign.', 1);
...
insert into ideas (kind, status, title, description, value, audience, tags, owner, votes, target_project_id, target_feature_id, created_at) values
  ...
  ('enhancement', 'captured', 'Bulk vendor invite from a saved list',
   ...
   array['vendors', 'productivity'], 'Tyler', 4, '11111111-1111-1111-1111-000000000001', '33333333-1111-0001-000000000001', '2026-05-23 10:00:00'),
  ...
  ('enhancement', 'captured', 'Reorder items across sections, not just within',
   ...
   array['drag-drop', 'sections'], 'Tyler', 2, '11111111-1111-1111-1111-000000000001', '33333333-1111-0001-000000000002', '2026-05-24 08:00:00'),
  ...
  ('enhancement', 'approved', 'Show approval gate reason on hover',
   ...
   array['ux', 'tooltips'], 'Tyler', 3, '11111111-1111-1111-1111-000000000001', '33333333-1111-0001-000000000004', '2026-05-24 09:30:00');
